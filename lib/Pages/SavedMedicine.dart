...
class SavedMedicine extends StatefulWidget {
   SavedMedicine({Key key}) : super(key: key);

  @override
  State<SavedMedicine> createState() => _SavedMedicineState();
}

class _SavedMedicineState extends State<SavedMedicine> {
  ...
  Future<void> _getMedicines() async {
    //toast("hello");
    _medicineList.clear();
    await databaseHelper.getAll('saved_data').then((value) {
  ...
  Future<void> filterSearchResults(String query) async {
    if(query.isNotEmpty) {
      var data=await databaseHelper.savedMedicineSearch(query);
